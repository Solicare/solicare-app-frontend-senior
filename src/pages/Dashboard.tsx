...
const Dashboard: React.FC = () => {
  ...
  return (
    <DashboardWrapper>
      <TopBar>
        <div>안녕하세요, 사용자님!</div>
        <a href="#" style={{ color: '#007bff', textDecoration: 'none' }}>로그아웃</a>
      </TopBar>
      <HeaderWrapper>
        <Header>
      ...
      <DashboardBody>
        {/* 오늘의 알림 - 그리드 위에 단독 배치 */}
        <NotificationCard>
          <div style={{ fontSize: '16px', color: '#6c757d', marginBottom: '8px', fontWeight: 500 }}>
            {today}
          </div>
        ...
        <DashboardCard>
          ...
          <CardDescription>
            <>
              내가 속한 동네 평균 걸음 수<br />
              <span style={{ fontWeight: 700, color: '#007bff', fontSize: '22px' }}>4,200보</span>
              <br />내 걸음 수<br />
              <span style={{ fontWeight: 700, color: '#28a745', fontSize: '22px' }}>{mockExerciseData.today.steps.toLocaleString()}보</span>
            </>
          </CardDescription>
          <div style={{ margin: '16px 0', fontWeight: 600, color: '#ff9800', fontSize: '18px' }}>
            상위 35%입니다! 👏
          </div>
          <CardButton
        ...
        <DashboardCard>
          ...
          <div style={{ margin: '12px 0', fontSize: '18px', color: '#007bff', fontWeight: 600 }}>
            최근 7일간 복용률: <span style={{ color: '#28a745', fontWeight: 700 }}>86%</span>
          </div>
          <div style={{ margin: '8px 0', fontSize: '16px', color: '#ff9800', fontWeight: 500 }}>
            복용 성공! 건강을 지키고 있어요 👍
          </div>
          <CardButton
